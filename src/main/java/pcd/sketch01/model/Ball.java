...
public class Ball {
    ...
    private PlayerId lastTouchedBy;
    
    private static double FRICTION_FACTOR = 0.25; 	/* 0 minimum */
    private static double RESTITUTION_FACTOR = 1; 

    public Ball(int id, P2d pos, double radius, double mass, V2d vel, PlayerId owner) {
        this.id = id;
        this.pos = pos;
        this.radius = radius;
        this.mass = mass;
        this.vel = vel;
        this.lastTouchedBy = PlayerId.NONE;
        this.owner = owner;
    }

    // todo: qui cambia lo stato di pos e vel (possibile race condition)
    ...
    public static void resolveCollision(Ball a, Ball b) {
        ...
        // 1. Ordiniamo i lock in base all'ID per prevenire deadlock
    ...
    public PlayerId getLastTouchedBy() {
        return this.lastTouchedBy;
    }

    public void setLastTouchedBy(PlayerId player) {
